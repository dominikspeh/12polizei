(function ($) {
    ...
    TreeMap.prototype.paint = function (nodeList) {
        ...
        for (var i = 0; i < nodeList.length; i++) {
            ...
            var $box = $('<div id=' + boxId + ' class="turnaround"></div>');
			...
			if(parseInt($box.width())<120) {
				...
				labelSet = "padding-top:"+ (parseInt($box.height()) / 2-8) +"px; font-size:12px;";
			}
			else if(parseInt($box.width())<180) {
				iconSet = "width:48%;";
				valueSet = "margin-top:" + (parseInt($box.height()) / 2-16) +"px; font-size:24px;";
				labelSet = "padding-top:"+ (parseInt($box.height()) / 2-10) +"px; font-size:16px;";
			}
			else {
				iconSet = '';
				valueSet = "margin-top:" + (parseInt($box.height()) / 2-20) +"px;";
